...
export const validationPizza = yup.object().shape({
  flavor: yup
    .string()
    .min(3, "nome deve ter 5 caracteres no mínimo")
    .required("Este campo é obrigatório"),
  type: yup
    .string()
    .min(2, "nome deve ter 2 caracteres no mínimo")
...
export const validationFieldIngredient = yup.string().matches(/^[a-zA-ZÀ-ÖØ-öø-ÿ\s]+$/, 'O nome deve conter somente letras')
